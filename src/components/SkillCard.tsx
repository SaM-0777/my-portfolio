...
function SkillCard({ image, title }: SkillCardProps) {
  return (
    <div className="w-[150px]">
      <div className="border-white border-[2px] p-[1px] h-[130px] rounded-xl flex justify-center items-center">
        <div className="bg-[#FFFFFF] p-1 rounded-xl w-full h-full">
          <img src={image} alt="skill" className="object-contain w-full h-full" />
        </div>
      </div>
      <div className="mt-3 bg-white rounded-xl h-[40px] justify-center items-center flex relative shadow-2xl">
